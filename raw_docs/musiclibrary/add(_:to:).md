...
> Source: https://developer.apple.com/documentation/musickit/musiclibrary/add(_:to:)
...
```
@discardableResult
func add<MusicItemType>(
    _ item: MusicItemType,
    to playlist: Playlist
) async throws -> Playlist where MusicItemType : MusicPlaylistAddable
```

## [Return Value](/documentation/musickit/musiclibrary/add(_:to:)#return-value)
