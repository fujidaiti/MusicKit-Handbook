...
> Source: https://developer.apple.com/documentation/musickit/artworkimage/init(_:width:)
...
## [Discussion](/documentation/musickit/artworkimage/init(_:width:)#discussion)
...
If you provide the width only, the artwork image calculates the height dimension
